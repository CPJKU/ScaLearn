...
class AdapterConfig(AdapterConfigBase):
    ...
    omega: Optional[Union[float, Mapping, None]] = None
    sparsity: Union[None, float] = None

    # Comment out to allow setting attributes -> omega
...
class ModelAdaptersConfig(Collection):
    ...
    def get_scalearn(
        ...
        if fusion_name in self.fusions:
            ...
            if config_name in self.fusion_config_map:
                ...
                config = SCALEARN_CONFIG_MAP.get(config_name, None)
        else:
            config = None
    ...
    def add_scalearn(
        ...
        if config is None:
            config = DEFAULT_SCALEARN_CONFIG
            # config = DEFAULT_ADAPTERFUSION_CONFIG
        if isinstance(config, str):
            if (
                config not in SCALEARN_CONFIG_MAP
                and config not in self.fusion_config_map
            ):
                raise ValueError(f"Invalid AdapterFusion config identifier '{config}'.")
            config_name = config
        # if it's a dict, compute it's hash and add a new entry to the config map
            ...
            raise ValueError("Invalid AdapterFusion config: {}".format(config))
        self.fusions[fusion_name] = config_name
        logger.info(f"Adding ScaLearn '{fusion_name}'.")
...
@dataclass(eq=False)
class ScaLearnConfig(AdapterConfigBase):
    """Base class that models the architecture of an adapter fusion layer."""

    query_before_ln: bool = False

    # GRID, not learned --> pairwise probing only!
    ...
    def load(cls, config: Union[dict, str], **kwargs):
        ...
        # currently storing AdapterFusion weights on AdapterHub is not supported.
        config_dict = resolve_adapter_config(
            config, local_map=SCALEARN_CONFIG_MAP, try_loading_from_hub=False
        )
        # convert back to dict to allow attr overrides
        if isinstance(config_dict, ScaLearnConfig):
            config_dict = config_dict.to_dict()
        config_dict.update(kwargs)
        return ScaLearnConfig.from_dict(config_dict)


@dataclass(eq=False)
class OmegaGrid(ScaLearnConfig):
    """Used for pairwise probing."""
    fn: bool = False
    query_before_ln: bool = False
    qqp: Union[None, float] = None
    mnli: Union[None, float] = None
...
@dataclass(eq=False)
class ScaLearnPlusPlusConfig2AvgInitDropout03(ScaLearnConfig):
...
@dataclass(eq=False)
class ScaLearnConfig2AvgInitDropout00MEAN(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
    omega_init_scale: float = 2.0
...
@dataclass(eq=False)
class ScaLearnConfig2AvgInitDropout00SOFTMAX(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
    omega_init_scale: float = 2.0
    dropout_ratio: float = 0.0
    take_softmax: bool = True


@dataclass(eq=False)
class ScaLearnUniformPlusPlusConfig2AvgInitDropout03(ScaLearnConfig):
    learn_omega: bool = True
    per_layer: bool = True
...
@dataclass(eq=False)
class ScaLearnUniformPlusPlusConfig2AvgInitDropout00(ScaLearnConfig):
    learn_omega: bool = True
    per_layer: bool = True
    omega_shape: str = "scalar"
    omega_init_type: str = "avg"
...
@dataclass(eq=False)
class ScaLearnConfig2AvgInitDropout03(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
    omega_init_scale: float = 2.0
...
@dataclass(eq=False)
class ScaLearnConfig3AvgInitDropout03(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
    omega_init_scale: float = 2.0
...
@dataclass(eq=False)
class ScaLearnConfigAvgInitDropout03(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
...
@dataclass(eq=False)
class ScaLearnConfigAvgInitDropout00(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
    omega_init_scale: float = 1.0
...
@dataclass(eq=False)
class ScaLearnUniformConfig2AvgInitDropout03(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "scalar"
    omega_init_type: str = "avg"
    omega_init_scale: float = 2.0
...
@dataclass(eq=False)
class ScaLearnUniformConfig2AvgInitDropout00(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "scalar"
    omega_init_type: str = "avg"
    omega_init_scale: float = 2.0
...
# REGULARIZATION
@dataclass(eq=False)
class ScaLearnConfigAvgInitDropout03Reg01(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
    omega_init_scale: float = 1.0
...
@dataclass(eq=False)
class ScaLearnConfigAvgInitDropout03Reg001(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
    omega_init_scale: float = 1.0
...
@dataclass(eq=False)
class ScaLearnConfig2AvgInitDropout03Reg01(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
    omega_init_scale: float = 2.0
...
@dataclass(eq=False)
class ScaLearnConfig2AvgInitDropout03Reg001(ScaLearnConfig):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
    omega_init_scale: float = 2.0
...
SCALEARN_CONFIG_MAP = {
    ...
    # SCALEARN
    "scalearn_avg_d03": ScaLearnConfigAvgInitDropout03(),
    "scalearn_avg_d00": ScaLearnConfigAvgInitDropout00(),
    "scalearn_2_avg_d03": ScaLearnConfig2AvgInitDropout03(),
    "scalearn_3_avg_d03": ScaLearnConfig3AvgInitDropout03(),
    # more efficient variations
    "scalearnUniform_2_avg_d03": ScaLearnUniformConfig2AvgInitDropout03(),
    "scalearnUniform_2_avg_d00": ScaLearnUniformConfig2AvgInitDropout00(),
    "scalearnPP_2_avg_d03": ScaLearnPlusPlusConfig2AvgInitDropout03(),
    "scalearnUniformPP_2_avg_d03": ScaLearnUniformPlusPlusConfig2AvgInitDropout03(),
    "scalearnUniformPP_2_avg_d00": ScaLearnUniformPlusPlusConfig2AvgInitDropout00(),
    # WITH REGULARIZATION
    "scalearn_avg_d03_reg01": ScaLearnConfigAvgInitDropout03Reg01(),
    "scalearn_avg_d03_reg001": ScaLearnConfigAvgInitDropout03Reg001(),
    "scalearn_2_avg_d03_reg01": ScaLearnConfig2AvgInitDropout03Reg01(),
    "scalearn_2_avg_d03_reg001": ScaLearnConfig2AvgInitDropout03Reg001(),
    # ABLATIONS
    "scalearn_2_avg_d00_MEAN": ScaLearnConfig2AvgInitDropout00MEAN(),
    "scalearn_2_avg_d00_SOFTMAX": ScaLearnConfig2AvgInitDropout00SOFTMAX(),
}

DEFAULT_ADAPTERFUSION_CONFIG = "dynamic"
DEFAULT_SCALEARN_CONFIG = "scalearn_2_avg_d03"
