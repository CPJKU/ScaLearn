...
class TFXLMRobertaEncoder(tf.keras.layers.Layer):
    def __init__(self, config: XLMRobertaConfig, **kwargs):
        ...
        self.config = config
        self.layer = [
            TFXLMRobertaLayer(config, name=f"layer_._{i}")
...
class TFXLMRobertaMainLayer(tf.keras.layers.Layer):
    ...
    def __init__(self, config, add_pooling_layer=True, **kwargs):
        ...
        self.pooler = (
            TFXLMRobertaPooler(config, name="pooler") if add_pooling_layer else None
        )
...
class TFXLMRobertaForMaskedLM(
    ...
    def __init__(self, config, *inputs, **kwargs):
        ...
        self.roberta = TFXLMRobertaMainLayer(
            config, add_pooling_layer=False, name="roberta"
        )
        self.lm_head = TFXLMRobertaLMHead(
