...
class TFRobertaPreLayerNormLayer(tf.keras.layers.Layer):
    def __init__(self, config: RobertaPreLayerNormConfig, **kwargs):
        ...
        if self.add_cross_attention:
            ...
            self.crossattention = TFRobertaPreLayerNormAttention(
                config, name="crossattention"
            )
        self.intermediate = TFRobertaPreLayerNormIntermediate(
...
class TFRobertaPreLayerNormEncoder(tf.keras.layers.Layer):
    def __init__(self, config: RobertaPreLayerNormConfig, **kwargs):
        ...
        self.config = config
        self.layer = [
            TFRobertaPreLayerNormLayer(config, name=f"layer_._{i}")
...
class TFRobertaPreLayerNormMainLayer(tf.keras.layers.Layer):
    ...
    def __init__(self, config, add_pooling_layer=True, **kwargs):
        ...
        self.pooler = (
            TFRobertaPreLayerNormPooler(config, name="pooler")
...
class TFRobertaPreLayerNormModel(TFRobertaPreLayerNormPreTrainedModel):
    def __init__(self, config, *inputs, **kwargs):
        ...
        self.roberta_prelayernorm = TFRobertaPreLayerNormMainLayer(
            config, name="roberta_prelayernorm"
        )
...
class TFRobertaPreLayerNormForMaskedLM(
    ...
    def __init__(self, config, *inputs, **kwargs):
        ...
        self.lm_head = TFRobertaPreLayerNormLMHead(
            config, self.roberta_prelayernorm.embeddings, name="lm_head"
        )
...
class TFRobertaPreLayerNormForCausalLM(
    ...
    def __init__(self, config: RobertaPreLayerNormConfig, *inputs, **kwargs):
        ...
        self.lm_head = TFRobertaPreLayerNormLMHead(
            config,
            input_embeddings=self.roberta_prelayernorm.embeddings,
            name="lm_head",
        )
...
class TFRobertaPreLayerNormForSequenceClassification(
    ...
    def __init__(self, config, *inputs, **kwargs):
        ...
        self.classifier = TFRobertaPreLayerNormClassificationHead(
