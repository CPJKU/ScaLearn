...
class TrainingArguments:
    ...
    freeze_adapter_for_steps: int = field(
        default=0, metadata={"help": "unfreezes the layer norms."}
    )
    mask_lr_ratio: float = field(default=1.0, metadata={"help": "The initial mask learning rate for AdamW, MTL."})
    learning_rate: float = field(default=5e-5, metadata={"help": "The initial learning rate for AdamW, STL."})
