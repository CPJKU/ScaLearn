...
def main():
    ...
    model.load_adapter(
        "comsense/cosmosqa@ukp", config=PfeifferConfig(), with_head=False
    )
    model.load_adapter("comsense/csqa@ukp", config=PfeifferConfig(), with_head=False)
    model.load_adapter(
        "comsense/hellaswag@ukp", config=PfeifferConfig(), with_head=False
    )
    model.load_adapter("comsense/siqa@ukp", config=PfeifferConfig(), with_head=False)
    model.load_adapter(
        "comsense/winogrande@ukp", config=PfeifferConfig(), with_head=False
    )
