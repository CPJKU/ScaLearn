...
class ConfigPushToHubTester(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        try:
            delete_repo(
                token=cls._token, repo_id="valid_org/test-generation-config-org"
            )
        except HTTPError:
            pass
    ...
    def test_push_to_hub(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            config.save_pretrained(
                tmp_dir,
                repo_id="test-generation-config",
                push_to_hub=True,
    ...
    def test_push_to_hub_in_organization(self):
        ...
        config.push_to_hub(
            "valid_org/test-generation-config-org", use_auth_token=self._token
        )
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            config.save_pretrained(
                tmp_dir,
                repo_id="valid_org/test-generation-config-org",
                push_to_hub=True,
                use_auth_token=self._token,
            )
