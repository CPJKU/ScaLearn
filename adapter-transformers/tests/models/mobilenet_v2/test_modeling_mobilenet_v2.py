...
class MobileNetV2ModelTester:
    def __init__(
        ...
        self.last_hidden_size = (
            ...
            else int(last_hidden_size * depth_multiplier)
        )
...
class MobileNetV2ModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = MobileNetV2ConfigTester(
            self, config_class=MobileNetV2Config, has_text_modality=False
        )
...
class MobileNetV2ModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_semantic_segmentation(self):
        ...
        feature_extractor = MobileNetV2FeatureExtractor.from_pretrained(
            "google/deeplabv3_mobilenet_v2_1.0_513"
        )
