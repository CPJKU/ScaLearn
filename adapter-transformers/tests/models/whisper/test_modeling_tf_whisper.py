...
class TFWhisperModelTest(TFModelTesterMixin, unittest.TestCase):
    ...
    def _get_encoder_outputs(
        ...
        input_ids = tf.zeros_like(
            input_ids[:, :1], dtype=tf.int64
        ) + tf.convert_to_tensor([model._get_decoder_start_token_id()])
        attention_mask = None
...
class TFWhisperModelIntegrationTests(unittest.TestCase):
    ...
    def test_large_logits_librispeech(self):
        ...
        run_test_in_subprocess(
            test_case=self,
            target_func=_test_large_logits_librispeech,
            inputs=None,
            timeout=timeout,
        )
    ...
    def test_large_generation(self):
        ...
        run_test_in_subprocess(
            test_case=self,
            target_func=_test_large_generation,
            inputs=None,
            timeout=timeout,
        )
    ...
    def test_large_generation_multilingual(self):
        ...
        run_test_in_subprocess(
            test_case=self,
            target_func=_test_large_generation_multilingual,
            inputs=None,
            timeout=timeout,
        )
    ...
    def test_large_batched_generation(self):
        ...
        run_test_in_subprocess(
            test_case=self,
            target_func=_test_large_batched_generation,
            inputs=None,
            timeout=timeout,
        )
