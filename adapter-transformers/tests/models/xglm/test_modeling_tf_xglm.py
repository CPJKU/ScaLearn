...
class TFXGLMModelTest(TFModelTesterMixin, unittest.TestCase):
    ...
    def test_batch_generation(self):
        ...
        num_paddings = (
            ...
            - tf.math.reduce_sum(
                tf.cast(inputs["attention_mask"][-1], dtype=tf.int64)
            ).numpy()
        )
...
class TFXGLMModelLanguageGenerationTest(unittest.TestCase):
    ...
    def test_lm_generate_xglm_left_padding(self):
        ...
        expected_output_string = "Today is a beautiful day and I am so glad that we have the opportunity to spend time with"
